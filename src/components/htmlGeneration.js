                                                            ...
                                                            <tr>
                                                                <td class="pad" align="right" style="padding-left:0px;padding-right:35px">
                                                                    <div style="line-height:10px;display:inline-block;width:182px">
                                                                        ...
                                                                        <img src="https://test-www.wgiftcard.com/private/561/images/activatebutton.png" style="display: block; height: auto; border: 0; max-width: 182px;" width="182" alt="ACTIVATE AND PRINT YOUR ${formData.giftCardNickname} NOW" title="ACTIVATE AND PRINT YOUR ${formData.giftCardNickname} NOW">
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                            </tr>
